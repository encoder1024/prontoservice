...
<body>
    ...
    <section id="header" class="header">
        ...
        <div class="container">
            <div class="starting">
                <div class="row">
                    <div class="col-md-6">
                        <img src="img/foto_1.png" alt="PS" class="wow flipInY animated animated">
                    </div>
                    <div class="col-md-6">
    ...
    <div id="speciality" class="wrapper">
        <div class="container">
            <h2 class="animation-box wow bounceIn animated">ESPECIALIDADES</h2>
            <div class="virticle-line"></div>
            <div class="circle"></div>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 wow animated fadeInRight">
                    <div class="features-list">
                        ...
                        <p>
                            La App incluye las siguientes características:
                        </p>
                        <ul class="right">
                            <li class="li"><i class="fa fa-chevron-right"></i> Buscador alfabético</li>
                            <li class="li"><i class="fa fa-chevron-right"></i> Navegador simple</li>
                            <li class="li"><i class="fa fa-chevron-right"></i> Información de prestadores</li>
                            <li class="li"><i class="fa fa-chevron-right"></i> Comunicación directa</li>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6 wow animated fadeInLeft">
                    <div class="features-list-left">
                        <h3>PARA EL PRESTADOR</h3>
                        <p>
                            La App incluye las siguientes características:
                        </p>
                        <ul class="left">
                            <li class="li">Comunicación directa<i class="fa fa-chevron-left"></i></li>
                            <li class="li">Información completa<i class="fa fa-chevron-left"></i></li>
                            <li class="li">Organización de tareas<i class="fa fa-chevron-left"></i></li>
                            <li class="li">Medición de resultados<i class="fa fa-chevron-left"></i></li>
    ...
    <section id="footer" class="wrapper">
        <div class="container text-center">
            <div class="footer-logo">
                <h1 class="text-center animation-box wow bounceIn animated">Pronto Service</h1>
            </div>
            <ul class="social-icons text-center">
                <li class="wow animated fadeInLeft facebook"><a href="#"><i class="fa fa-instagram"></i></a></li>
